...
%o`, message, error2, detail);
  ...
  var emoji_controller_default = class extends Controller {
    connect() {
  ...
  __publicField(emoji_controller_default, "targets", ["picker"]);

  // app/javascript/application.js
  window.Stimulus = Application.start();
  Stimulus.register("emoji", emoji_controller_default);
})();
